...
## Grading sketch (optional)

| Criterion | Weight |
|-----------|--------|
| Re-runnable computed figures | 25% |
| Decision language for track | 20% |
| Audit log + lineage | 20% |
| Hypothesis → scenario chain | 15% |
| Dual audience quality | 20% |
